...
#define e11 0.0f,1.0f,0.5f
	...
	const vector<vector<unsigned int>> _case_texture_ids
	{
		{},//None
		{ 0,0,0 },//v0 --1
		{ 1,1,0,0 },//v0,v1 --2
		{ 0,0,0, 5,5,5 },//v0,v5 --3
		{ 0,0,0, 6,6,6 },//v0,v6 --4
		{ 1,3,1,3,2 },//v3,v1,v2 --5
		{ 1,1,0,0, 6,6,6 },//v0,v1,v6 --6
		{ 1,1,1, 4,4,4, 6,6,6 },//v1,v4,v6 --7
		{ 0,1,2,3 },//v0,v1,v2,v3 --8
		{ 0,2,0,2,7,7 },//v0,v2,v3,v7 --9
		{ 0,0,4,4, 2,2,6,6 },//v0,v2,v4,v6 --10
		{ 0,0,2,3,6,6 },//v0,v3,v2,v6 --11
		{ 1,3,1,3,2, 4,4,4 },//v1,v2,v3,v4 --12
		{ 0,0,0, 5,5,5, 2,2,2, 7,7,7 },//v0,v2,v7,v5 --13
		{ 1,3,7,1,2,7 },//v1,v2,v3,v7 --14

		//Ambiguous cases
		{ 1,3,4,4,1,6 },//v1,v2,v3,v4,v6,v7 --3c (15)
		{ 4,3,2,5,7,5,2 },//v3,v2,v4,v5,v7 --6c (16)
		{ 0,0,7,7,2,2, 5,5,5 },//v0,v3,v2,v7,v5 -- 7c (17)
		{ 1,1,5,5, 3,3,7,7 }, //v1,v5,v3,v7 --10c (18)
		{ 0,0,0, 7,7,5,5,6 }, //v0,v7,v6,v5 --12c(19)
		{ 1,4,3, 3,6,1, 4,6,3, 6,4,1 }, //v0,v2,v7,v5 --13c(20)
	};
