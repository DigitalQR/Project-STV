...
#define e11 0.0f,1.0f,0.5f
	...
	const vector<vector<float>> _case_vertices
	{
		...
		{ e0,e5,e1, e9,e1,e6, e11,e7,e4, e7,e3,e2 }, //v0,v2,v7,v5 --13c(20)
	};
	...
	const vector<vector<unsigned int>> _case_indices
	{
		...
		{ 0,1,3, 0,3,5, 0,5,2, 3,4,5 },//v0,v3,v2,v6
		{ 0,1,3, 0,3,2, 2,3,4,  6,5,7 },//v1,v2,v3,v4
		{ 0,1,2,  3,4,5,  7,8,6,  9,10,11 },//v0,v2,v7,v5
		{ 0,1,2, 0,2,4, 2,5,4, 4,3,0 },//v1,v2,v3,v7

		//Ambiguous cases
		{ 2,3,1, 1,3,5, 1,4,0, 1,5,4 },//v1,v2,v3,v4,v6,v7 --3c
		{ 3,5,4, 3,0,4, 0,4,1, 1,2,4, 2,4,6 },//v3,v2,v4,v5,v7 --6c (16)
